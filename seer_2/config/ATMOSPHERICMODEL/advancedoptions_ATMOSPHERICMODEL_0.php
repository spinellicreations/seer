...
---------------------------------------------------------------------
ATMOSPHERICMODEL ADVANCED OPTIONS FILE
...
/* ------------------------------------------------------------------ */
$MODEL_CODENAME_TO_USE = $ATMOSPHERICMODEL_CODENAME;
/*	-- codename of model (as referenced from global options file) */
$MODEL_NAME_TO_USE = $multilang_ATMOSPHERICMODEL_0;
...
$MODEL_TABLE_TO_USE[0] = $ATMOSPHERICMODEL_mysql_mod_openopc_TABLENAME;
...
$MODEL_QUERY_TO_RUN[0] = "CREATE TABLE IF NOT EXISTS ".$MODEL_TABLE_TO_USE[0]." (DATESTAMP VARCHAR(20), INDEX(DATESTAMP), MACHINENAME VARCHAR(30), INDEX(MACHINENAME), TEMPERATURE FLOAT(7,2), HUMIDITY FLOAT (7,2), PRESSURE FLOAT(7,2))";
...
$MODEL_FORMFILL_MODELS_TO_USE = $seer_ATMOSPHERICMODEL_FORMFILL_MODELS;
/*	-- formfill of models (local options instances) as taken from */
/*	   the global options file */

/* MODEL HMI AND REPORT IDENTIFICATION */
/* ------------------------------------------------------------------ */
$MODEL_HMI_ID[0] = array("hmi_0", $multilang_ATMOSPHERICMODEL_1);
...
$MODEL_REPORT_ID[0] = array("report_0", $multilang_ATMOSPHERICMODEL_2);

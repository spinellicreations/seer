...
---------------------------------------------------------------------
BULKMODEL ADVANCED LOCAL-COMMON FILE
...
/* -- COUNT */
/* -------- */
$BULKMODEL_COUNT_ADJUSTED = $BULKMODEL_COUNT - 1;
/*	-- this offsets by 1 for array construction */
/*	-- do not edit */

/*	FORM FILL FOR ABOVE */
/*	------------------- */
$BULKMODEL_FORMFILL_NAME = "";
$BULKMODEL_COUNT_CYCLE = 0;
while ( $BULKMODEL_COUNT_CYCLE <= $BULKMODEL_COUNT_ADJUSTED ) {
	$BULKMODEL_FORMFILL_NAME = $BULKMODEL_FORMFILL_NAME."<OPTION VALUE='".$BULKMODEL_NAME[$BULKMODEL_COUNT_CYCLE]."'>".$BULKMODEL_NAME[$BULKMODEL_COUNT_CYCLE];
	$BULKMODEL_COUNT_CYCLE = $BULKMODEL_COUNT_CYCLE + 1;
}

...
---------------------------------------------------------------------
BULKMODEL ADVANCED OPTIONS FILE
...
/* ------------------------------------------------------------------ */
$MODEL_CODENAME_TO_USE = $BULKMODEL_CODENAME;
/*	-- codename of model (as referenced from global options file) */
$MODEL_NAME_TO_USE = $multilang_BULKMODEL_0;
...
$MODEL_TABLE_TO_USE[0] = $BULKMODEL_mysql_mod_openopc_TABLENAME;
...
$MODEL_QUERY_TO_RUN[0] = "CREATE TABLE IF NOT EXISTS ".$MODEL_TABLE_TO_USE[0]." (DATESTAMP VARCHAR(20), INDEX(DATESTAMP), BULKNAME VARCHAR(30), INDEX(BULKNAME), INVENTORY_PERCENT SMALLINT, INVENTORY_QUANTITY INT)"; 
...
$MODEL_REPORT_ID[0] = array("report_0", $multilang_BULKMODEL_2);
$MODEL_REPORT_ID[1] = array("report_1", $multilang_BULKMODEL_3);
$MODEL_REPORT_ID[2] = array("report_2", $multilang_BULKMODEL_31);

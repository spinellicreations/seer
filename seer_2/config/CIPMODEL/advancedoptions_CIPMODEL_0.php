...
---------------------------------------------------------------------
CIPMODEL ADVANCED OPTIONS FILE
...
/* ------------------------------------------------------------------ */
$MODEL_CODENAME_TO_USE = $CIPMODEL_CODENAME;
/*	-- codename of model (as referenced from global options file) */
$MODEL_NAME_TO_USE = $multilang_CIPMODEL_0;
...
$MODEL_TABLE_TO_USE[0] = $CIPMODEL_mysql_mod_openopc_TABLENAME;
...
$MODEL_QUERY_TO_RUN[0] = "CREATE TABLE IF NOT EXISTS ".$MODEL_TABLE_TO_USE[0]." (DATESTAMP VARCHAR(20), INDEX(DATESTAMP), CIPNAME VARCHAR(30), INDEX(CIPNAME), STATUS SMALLINT, INDEX(STATUS), LINE_BEING_CLEANED SMALLINT, INDEX(LINE_BEING_CLEANED), STEP SMALLINT, INDEX(STEP), SUPPLY_TEMP SMALLINT, RETURN_TEMP SMALLINT, SUPPLY_FLOW SMALLINT, RETURN_CONDUCTIVITY MEDIUMINT, WATER_USAGE MEDIUMINT, WATER_TYPE TINYINT, INDEX(WATER_TYPE), CERTIFIED VARCHAR(20), INDEX(CERTIFIED), CERTIFIEDBY VARCHAR(30), INDEX(CERTIFIEDBY), CERTIFIEDCOMMENT VARCHAR(60))";
...
$MODEL_FORMFILL_MODELS_TO_USE = $seer_CIPMODEL_FORMFILL_MODELS;
/*	-- formfill of models (local options instances) as taken from */
/*	   the global options file */

/* MODEL HMI AND REPORT IDENTIFICATION */
/* ------------------------------------------------------------------ */
$MODEL_HMI_ID[0] = array("hmi_0", $multilang_CIPMODEL_1);
$MODEL_HMI_ID[1] = array("hmi_1", $multilang_CIPMODEL_2);
$MODEL_HMI_ID[2] = array("hmi_2", $multilang_CIPMODEL_3);
...
$MODEL_REPORT_ID[0] = array("report_0", $multilang_CIPMODEL_4);
$MODEL_REPORT_ID[1] = array("report_1", $multilang_CIPMODEL_5);
$MODEL_REPORT_ID[2] = array("report_2", $multilang_CIPMODEL_6);
$MODEL_REPORT_ID[3] = array("report_3", $multilang_CIPMODEL_7);
$MODEL_REPORT_ID[4] = array("report_4", $multilang_CIPMODEL_8);

...
---------------------------------------------------------------------
TANK REPORT 3 BODY (INCLUDED TO ALL TANKMODELS)
---------------------------------------------------------------------
*/
...
$apache_PAGETITLE = "
							<P CLASS='PAGETITLE'>
								<B>".$multilang_TANKMODEL_0.": ".$multilang_TANKMODEL_9."</B><BR>
...
if ( $seer_HMIACTION == 'BUILDTICKET' ) {
	...
	if ( $seer_HMIACTION_FAULT == 0 ) {
		...
		list($fault_container_TOPRATED,$machine_fault_index_container_TOPRATED) = model_COMMON_top_rated_fault_container_creation_report_3($TANKMODEL_COUNT_ADJUSTED,$machine_fault_index_container,$fault_container,$endtime_container,$starttime_container,$duration_container_human_readable,$duration_container_unixtime,$post_bypass_TOPRATED_CHECK_2="ALLOW_FAULT_ID_ZERO");
		...
		if ( $machine_fault_index_container_TOPRATED == 0 ) {
			...
			$apache_PARETO = core_pareto_determination_and_plot("DURATION",$multilang_TANKMODEL_107, $TANKMODEL_PRODUCT_COUNT_ADJUSTED, $TANKMODEL_PRODUCT, $fault_container_TOTAL_TOPRATED, $post_NO_ALARM_STATE="YES");
			...
			$apache_PARETO = core_pareto_determination_and_plot("FREQUENCY",$multilang_TANKMODEL_107, $TANKMODEL_PRODUCT_COUNT_ADJUSTED, $TANKMODEL_PRODUCT, $fault_container_TOTAL_TOPRATED, $post_NO_ALARM_STATE="YES");
			$apache_REPORT_RECORDENTRY = $apache_REPORT_RECORDENTRY.$apache_PARETO;
		...
		/* -- BUILD THE TOP PLATE */
		$apache_REPORT_RECORDENTRY_TOPPLATE = core_report_ticket_top_plate_and_export_link($mysql_ENTRY_MACHINENAME,"csv",$mysql_query_START_DATESTAMP,$mysql_query_END_DATESTAMP,$multilang_STATIC_PARETO_EXPLAIN,$multilang_STATIC_SORTING_STATUS_EXPLAIN);

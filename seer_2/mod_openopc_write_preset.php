...
-- REQUEST WRITE SUBROUTINE BE RUN UPON A PRESET (mywrite).WRT FILE
---------------------------------------------------------------------
*/
...
/* ------------------------------------------------------------------ */
mod_openopc_input_and_sanity_check("WRITE_PRESET");
...
if ( $apache_EXECUTETHISFUNCTION == "YES" ) {
	...
	*/
	...
	$mod_openopc_EVENTFILE_LINE3 = "YOURWRITETYPE:PRESET\n";
	$mod_openopc_EVENTFILE_LINE4 = "# -- WRITE FROM PRESET FILE\n";
	$mod_openopc_EVENTFILE_LINE5 = "[your_leafers]\n";
	$mod_openopc_EVENTFILE_LINE6 = "YOURLEAFERS:NONE\n";
	$mod_openopc_EVENTFILE_LINE7 = "YOURWRITEPRESET:".$mod_openopc_YOURWRITEPRESET."\n";
	...
	$apache_REPORT = "
						<DIV CLASS='DAEMONREPORT'>
							<P CLASS='DAEMONREPORT'>
								...
								mod_openopc_YOURWRITEPRESET ... ".$mod_openopc_YOURWRITEPRESET."<BR>

...
---------------------------------------------------------------------
MACHINE CONTROL & LIVE STATUS MENU
---------------------------------------------------------------------
*/
...
if ( $seer_ENABLE_TANKMODEL == "YES" ) {
	$apache_LINK_TANKMODEL = machinecontrol_menu_markup("TANKMODEL");
} else {
...
if ( $seer_ENABLE_SPFMODEL == "YES" ) {
	$apache_LINK_SPFMODEL = machinecontrol_menu_markup("SPFMODEL");
} else {
...
if ( $seer_ENABLE_WARRIOR == "YES" ) {
	$apache_LINK_WARRIOR = machinecontrol_menu_markup("WARRIOR");
} else {
	$apache_LINK_WARRIOR = "";
}
...
if ( $seer_ENABLE_CHECKWEIGHERMODEL == "YES" ) {
	$apache_LINK_CHECKWEIGHERMODEL = machinecontrol_menu_markup("CHECKWEIGHERMODEL");
} else {
...
if ( $seer_ENABLE_TTYPERFORMANCEMODEL == "YES" ) {
	$apache_LINK_TTYPERFORMANCEMODEL = machinecontrol_menu_markup("TTYPERFORMANCEMODEL");
} else {
...
if ( $seer_ENABLE_CIPMODEL == "YES" ) {
	$apache_LINK_CIPMODEL = machinecontrol_menu_markup("CIPMODEL");
} else {
...
if ( $seer_ENABLE_BULKMODEL == "YES" ) {
	$apache_LINK_BULKMODEL = machinecontrol_menu_markup("BULKMODEL");
} else {
	$apache_LINK_BULKMODEL = "";
}
...
if ( $seer_ENABLE_TOUCHPANEL == "YES" ) {
	$apache_LINK_TOUCHPANEL = machinecontrol_menu_markup("TOUCHPANEL");
} else {
...
if ( $seer_ENABLE_THINCHART == "YES" ) {
	$apache_LINK_THINCHART = machinecontrol_menu_markup("THINCHART");
} else {
	$apache_LINK_BULKMODEL = "";
}
...
if ( $seer_ENABLE_ATMOSPHERICMODEL == "YES" ) {
	$apache_LINK_ATMOSPHERICMODEL = machinecontrol_menu_markup("ATMOSPHERICMODEL");
} else {
